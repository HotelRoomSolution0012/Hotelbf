...
<head>
  ...
  <meta name="Author" content="chaoto">
...
<div id="section">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="info_group">
                        <label>入住时间</label><input type="date" name="arriveDate" id="arriveDate" value="2020/7/30"/>
						<label>离店时间</label><input type="date" name="leaveDate" id="leaveDate" value="2020/7/31"/>
                    </div>
    ...
    <div class="malog">
        <div class="message">
            ...
            <p><span class="num"></span><a href="../index"></a></p>
        </div>
    </div>
